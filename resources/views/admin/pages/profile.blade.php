                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    ...
                                    <div>
                                        <span class="heading">{{ $symbol }}{{ round($payment,2) }}</span>
                        ...
                        <form class="form-horizontal" action="{{ url('/admin/profile/changepassword') }}"
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" value="{{old('old_password')}}" class="form-control" name="old_password" id="old_password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" value="{{old('new_password')}}" name="new_password" id="new_password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="confirm_password"
                                        id="confirm_password" value="{{old('confirm_password')}}" placeholder="{{ __('Confirm New Password') }}">
