            ...
            <div class="card card-profile shadow">
                ...
                <div class="card-body ">
                    ...
                    <div class="text-center">
                        <h3>
                            Name:{{ $user->name }}<span class="font-weight-light"></span>   
                        </h3>
                        <div>
                        ...
                        <div id="detail_div_a4">                      
                            <embed src="{{asset('upload/pdffile/' .$user->file)}}" type="application/pdf" width="100%" height="450px">
                        </div>
