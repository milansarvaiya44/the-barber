...
function addDay(ev, day) {
    ...
    <td class="row-index"><input type="text" value="08:00 AM" name="start_time_`+day+`[]" class="timepicker" ></td>
    <td class="row-index"><input type="text" value="08:00 PM" name="end_time_`+day+`[]" class="timepicker"  ></td>
...
//gst/vat/services
$(".add_gstvatservices").click(function (){
    $(".invalid-div span").html('');
    $("#add_gstvatservices_sidebar").slideDown(50), $("#add_gstvatservices_sidebar").toggleClass("show_sidebar_create")
});
$(".edit_gstvatservices_close").click(function (){
    $("#edit_gstvatservices_sidebar").slideDown(50), $("#edit_gstvatservices_sidebar").toggleClass("show_sidebar_edit")
});
...
function edit_gstvatservices(id,base_url) {
    $.ajax({
        headers: {
            'XCSRF-TOKEN': csrf
        },
        ...
        success: function(result){
            ...
            $("#edit_gstvatservices_sidebar input[name='type']").val(result.data.type);
            $("#edit_gstvatservices_sidebar input[name='gst']").val(result.data.gst);
            $("#edit_gstvatservices_sidebar input[name='vat']").val(result.data.vat);
            $("#edit_gstvatservices_sidebar input[name='services_charges']").val(result.data.services_charges);
            $("#edit_gstvatservices_sidebar textarea#desc").html(result.data.desc);
